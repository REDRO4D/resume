        ...
        <Fragment>
            <div className="container">
                <div className="info-wrapper">
                    ...
                    <p className="name">Soy Bruno Rosales</p>
                    <p className="profession">Desarrollador</p>
                    <a href="#">Contactar</a>
                </div>
                ...
                <div className="social-media-wrapper">
                    ...
                    <a href="#" title="Perfil de Github">
                        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="438.536px" height="438.536px" viewBox="0 0 438.536 438.536">
                            <g>
                                <g>
